...
<title>Citizen Card Business User Application Online</title>
...
<h1 style="text-align:center;color: #080f17c2;" ><b>Citizen Card Business User Application Online</b></h1>
      <!--   <hr/> -->
  ...
  <tr>
   ...
   <tr>
    ...
    <th><label><b>Login </b></th>
     <td>  <button type="submit" onclick="validate()">Business User Login</button></td>
  </tr>
   <tr>
